...
class OnlineInspectionLotFieldDetailScreen extends StatelessWidget {
  OnlineInspectionLotFieldDetailScreen({super.key});

  final OnlineInspectionViewModel inspectinDetailPageController = Get.put(OnlineInspectionViewModel());
  Size size = Get.size;
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            Container(
              padding: EdgeInsets.only(left: 10, right: 3, bottom: 0, top: 25),
              ...
              child: Row(
                children: [
                  ...
                  Tooltip(
                    message: inspectinDetailPageController.inspection_name.value.toString()+' Insepection',
                    child: Container(
                      width: size.width*.7,
                      padding: EdgeInsets.only(left:3),
                      child: Text('${inspectinDetailPageController.inspection_name.value}'+' Insepection',
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      inspectinDetailPageController
                          .showLotDetailsBottomSheet(context);
                    },
                  ),
                ],
              ),
            ...
            Container(
              decoration: BoxDecoration(
                ...
                border:
                    Border.all(color: AllColors.primaryliteColor, width: .2),
              ),
              child: Padding(
              ...
              children: [
                Align(
                  ...
                  child: Container(
                    ...
                    child: Obx(() {
                      return Visibility(
                        visible: inspectinDetailPageController
                                        .online_offline_selected_inspection
                                        .value!
                                        .isDone !=
                                    null &&
                            ...
                            Container(
                              ...
                              child: ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                    ...
                                    foregroundColor: AllColors.lightgreyColor),
                                onPressed: () {
                                  inspectinDetailPageController.online_offline_selected_inspection.value.fields!.forEach((element) {
                                    if(element.isReadOnly!<=0 && element.isMap!<=0 && element.mapInspectionFieldName!='planting_line'){
                                      element.edit_text_field!.text='';
                                      element.fieldValue='';
                                    }
                                  });
  ...
  Widget BindInputFields(context) {
    return Expanded(
      child: ListView.builder(
          ...
          shrinkWrap: true,
          itemCount: (inspectinDetailPageController
                      .online_offline_selected_inspection
                      .value
                      .inspectionTypeName ==
                  null)
              ? 0
              : inspectinDetailPageController
                  .online_offline_selected_inspection.value.fields!.length,
