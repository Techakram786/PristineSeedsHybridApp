...
class LotDetailScreen extends StatelessWidget{
  LotDetailScreen({super.key});
  final OfflineInspectionViewModel lotDetailPageController=Get.put(OfflineInspectionViewModel());
  Size size=Get.size;
  Future<bool> onWillPop() async {
    lotDetailPageController.syncOfflineDataPushToApiAfterThatGetData('OfflineLotDetail');
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          child: Text(
                            lotDetailPageController.onlineOffline_selected_lot_data.value!=null && lotDetailPageController.onlineOffline_selected_lot_data.value.productionLotNo!=null?"Offline Lot ("+lotDetailPageController.onlineOffline_selected_lot_data.value.productionLotNo!+")":'',
    ...
    return Wrap(
      ...
      children: List<Widget>.generate(lotDetailPageController.onlineOffline_selected_lot_data.value.inspectionDetail!.length, (int index) {
        return ActionChip(
          ...
          onPressed: () {
            if(lotDetailPageController.onlineOffline_selected_lot_data.value.inspectionDetail![index].isDone!>0 || index==0){
              ...
              Get.toNamed(RoutesName.inspectionLotFieldDetailScreen);
            }
